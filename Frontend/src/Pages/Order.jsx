            ...
            <div className="w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative">
              ...
              <div className="flex items-start justify-center flex-col gap-[5px] ">
                ...
                <div className="flex items-center">
                  <p className="md:text-[18px] text-[12px] text-[#aaf4e7] ">
                    Date:{" "}
                    <span className="text-[#e4dbff] pl-[10px] md:text-[16px] text-[11px] ">
                ...
                <div className="absolute md:right-[5%]  md:top-[40%] right-[2%] top-[75%]">
                  <button
                    className="md:px-[15px] px-[5px] md:py-[7px] py-[3px] rounded-md bg-[#101919] text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointer active:bg-slate-500"
